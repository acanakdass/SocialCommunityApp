...
namespace WebAPI.Controllers
{
    ...
    public class PostsController : ControllerBase
    {
        ...
        [HttpGet("get-by-id-included/{id}")]
        public async Task<IActionResult> GetByIdIncluded(int id)
        {
            var result = await _service.GetByIdIncludedAsync(id);
            return Ok(result);
        }
        ...
        [HttpPost]
        public async Task<IActionResult> Create([FromBody] Post createRequestDto)
        {
        ...
        //[CacheRemoveAspect("Products.GetAll,Products.GetAllDynamic,Products.GetById,Products.GetAllDynamic")]
        [HttpPut]
        public async Task<IActionResult> Update([FromBody] Post updateRequestDto)
        {
